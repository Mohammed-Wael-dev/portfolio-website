        ...
        <div className="relative h-full min-h-full w-full">
            <div className={`${landingSectionStyle.landingConainer} flex justify-between px-[10%] items-center`}>
                <div className={`${landingSectionStyle.landingSection} text-white`}>
                    <h3 style={{textShadow: "1px 1px 0 0 #2a1249"}}className="text-3xl mb-[20px] text-[#583686] font-semibold tracking-[10px] uppercase">Mohammed Wael</h3>
                    ...
                    <div className={`${landingSectionStyle.btnContainer} flex gap-x-[30px] mt-[20px]`}>
                        <a href="#portfolio" className="border border-white rounded-[5px] p-[15px] duration-[0.8s] hover:bg-[#583686] hover:text-white hover:text-[1.1rem]">See the Latest Works</a>
                        <a href="#Contact" className="bg-white text-black rounded-[5px] p-[15px] duration-[0.8s] hover:bg-[#583686] hover:border hover:border-white hover:text-white hover:text-[1.1rem]">Contact Me</a>
                    </div>
                </div>
